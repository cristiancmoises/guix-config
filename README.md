...
- 🧠 **AMD Ryzen 3 2200G** CPU (4 cores, 4 threads)
...
- ✅ **CPU Efficiency**: XanMod kernel with AMD P-state, full preemption, and all 4 threads enabled for maximum responsiveness.
...
The system uses the **XanMod kernel** with optimized kernel-arguments for **performance**, **security**, and **stability**. All 4 threads of the Ryzen 3 2200G are enabled for maximum multithreaded performance. Below is a detailed table explaining each kernel argument in simple terms.
